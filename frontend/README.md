Follow below Steps to run CRM Nexus web application in your system:

 #### Step 1: Clone the repository

```bash
git remote add origin https://github.com/jenish04/CRM_Nexus_Web_Application.git
```

```bash
cd CRM Nexus Web Application
```
